"""Claude subprocess runner for the Browser Interactor layer (搂5.2)."""
...
def _build_command():
    """Build the legacy Claude CLI command while preserving Windows behavior."""
...
def run_claude(prompt, timeout_seconds=600, max_retries=2):
    """Run Claude with retry/timeout handling and legacy stdin prompt delivery."""
    ...
    for attempt in range(1, max_retries + 1):
        ...
        try:
            ...
            # Non-zero exit with empty output: retry once (per plan 搂LLMORACLE)
